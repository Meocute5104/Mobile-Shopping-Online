...
public class LaptopServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        ArrayList<Command> list2 = cd.getAll();
        request.setAttribute("commandList", list2);
        ...
        ArrayList<Product> saleList = pD.getTop10ByPriceAsc();
        request.setAttribute("saleList", saleList);

        //Show san pham
        ArrayList<Product> list = pD.getTopAll(brandId, priceId, screenId, op);
        int total = list.size();
