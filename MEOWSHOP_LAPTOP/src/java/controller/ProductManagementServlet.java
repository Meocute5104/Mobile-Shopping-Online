 ...
 * @author MSII
 */
@WebServlet(name="ProductManagementServlet", urlPatterns={"/productmanager"})
public class ProductManagementServlet extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        ArrayList<ProductColor> list = pcd.getAllProductColor(key, op);
        ...
        ArrayList<ProductColor> listPage = pcd.getListByPage(list, start, end);
