...
<html lang="en">
    ...
    <head>
        ...
        <title>${requestScope.brandName}</title>
            ...
            <div style="margin-top: 15px">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb" style="font-size: 12px;">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">${requestScope.brandName}</li>
                    </ol>
                </nav>
            </div>
            <div style="display: flex;">
                <div style="width: 75%;">
                    <div style="margin-top: 10px;">
                        <h3 style="font-weight: bold;">${requestScope.brandName}</h3>
                    </div>
                                ...
                                <c:forEach items="${requestScope.brandList}" var="b">
                                    <div class="item">
                                        <a style="text-decoration: none; color: black;" href="laptoplist?brand=${b.id}">
                                            <div class="br" style="font-size: 12px; ${(b.id == requestScope.brandId) ? "font-weight: bold;" : ""}">${b.name}</div>
                                        </a>
                                    </div>
                                </c:forEach>
                            </div>
                    ...
                    <c:if test="${requestScope.total != 0}">
                        ...
                        <div style="margin-left: 215px;margin-top: 20px;">
                            <nav aria-label="Page navigation example">
                                <ul class="pagination">
                                    <li class="page-item"><a class="page-link" href="laptoplist?page=${page-1 == 0 ? requestScope.num : (page -1)}&brand=${requestScope.brandId}&price=${requestScope.priceId}&screen=${requestScope.screenId}&sort=${requestScope.op}">Previous</a></li>
                                    ...
                                    <li class="page-item"><a class="page-link" href="laptoplist?page=${page+1 == (requestScope.num + 1) ? 1 : (page + 1)}&brand=${requestScope.brandId}&price=${requestScope.priceId}&screen=${requestScope.screenId}&sort=${requestScope.op}">Next</a></li>
                                </ul>
                            </nav>
                        </div>
                    </c:if>
