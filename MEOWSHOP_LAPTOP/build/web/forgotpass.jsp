    ...
    <body>
        ...
        <div id="bgHome" style="display: flex; justify-content: center;">
            ...
            <div style="margin: 0 auto; width: 40%; height: 100vh; border-radius: 20px; padding: 30px;">
                ...
                <!-- Pills navs -->
                <ul style="background-color: rgba(245, 245, 245, 0.7); border-radius: 5px;" class="nav nav-pills nav-justified mb-3" id="ex1" role="tablist">
                ...
                <div class="tab-content">
                    <div style=" padding: 18px; background-color: rgba(247, 209, 215, 0.7); border-radius: 20px;" class="tab-pane fade show active" id="pills-login" role="tabpanel" aria-labelledby="tab-login">
                        <form action="forgot" method="post">
                            ...
                            <div class="row mb-4">
                                <div class="col-md-6 d-flex justify-content-center">
                                    ...
                                    <div class="form-check mb-3 mb-md-0">
                                        <input class="form-check-input" type="hidden" value="" id="loginCheck" checked />
                                        <label class="form-check-label" for="loginCheck"></label>
                                    </div>
                                </div>
                            ...
                            <!-- Submit button -->
                            <button type="submit" class="btn btn-primary btn-block mb-4">Get new password</button>

                            <!-- Register buttons -->
                            <div class="text-center">
                                <p>Not a member? <a href="signin" id="register-link">Register</a></p>
                            </div>
                        </form>
                    </div>
